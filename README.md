...
| | SP曹仁 | 孙策 | 吕布 |
|---|---|---|---|
| 立绘 | <img src="public/generals/spcaoren.png" alt="SP曹仁" width="140"> | <img src="public/generals/sunce.webp" alt="孙策" width="140"> | <img src="public/generals/lvbu.jpg" alt="吕布" width="140"> |
| 阵营 | 魏 · 天人之勇 | 吴 · 小霸王 | 群 · 飞将 |
| 武力 | A（180） | S（200） | S（200） |
| 智力 | B（160） | B（160） | D（100） |
| 统帅 | S（90） | A（80） | A（80） |
| 速度 | C（70） | A（90） | S（100） |
| 自带战法 | 天人之勇 · 指挥 | 覆海平山 · 主动 | 无前 · 被动 |
